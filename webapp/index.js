...
app.listen(config.server.port, () => {
  ...
  console.log(`OpenID Connect issuer: ${config.oidc.baseUrl} (client ID: ${config.oidc.clientId})`);
  console.log(`GitHub app ID: ${config.github.app.id}`);
  console.log(`GitHub registry: ${config.github.registry.owner}/${config.github.registry.repo}`);
});